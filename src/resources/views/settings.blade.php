...
<div class="row">
    <div class="col-12">
        ...
        <form action="{{ route('corpwalletmanager.settings.update') }}" method="POST">
            ...
            <!-- Member View Settings Card - NEW SECTION -->
            <div class="card mt-3">
                <div class="card-header">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <div class="form-check">
                                    <input type="hidden" name="member_show_health" value="0">
                            ...
                            <div class="form-group">
                                <div class="form-check">
                                    <input type="hidden" name="member_show_trends" value="0">
                            ...
                            <div class="form-group">
                                <div class="form-check">
                                    <input type="hidden" name="member_show_activity" value="0">
                            ...
                            <div class="form-group">
                                <div class="form-check">
                                    <input type="hidden" name="member_show_goals" value="0">
                            ...
                            <div class="form-group">
                                <div class="form-check">
                                    <input type="hidden" name="member_show_milestones" value="0">
                            ...
                            <div class="form-group">
                                <div class="form-check">
                                    <input type="hidden" name="member_show_balance" value="0">
                            ...
                            <div class="form-group">
                                <div class="form-check">
                                    <input type="hidden" name="member_show_performance" value="0">
...
function loadAccessLogs() {
    fetch('{{ route("corpwalletmanager.settings.access-logs") }}')
        .then(response => response.json())
        .then(data => {
