{{--
    Annual retrospective PDF template.

    Cover page + Executive Summary + Monthly Trend + Top Contributors +
    Activity Mix + Notable Transactions + Division Performance +
    Alliance Tax Remits + Milestones + Risk Assessment + YoY comparison.

    Sections live in _partials.blade.php so the quarterly template can
    re-use them verbatim. Inline CSS matches the convention from
    report.blade.php (DejaVu Sans, indigo headings, light-grey table
    borders, summary-grid for two-column key/value layouts).
--}}
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
<title>Annual Wallet Report - {{ $corpName }}</title>
<style>
...
<div class="cover">
    ...
    <h2 style="border: 0; color: #333;">Annual Report</h2>
...
{{-- Body — all retrospective sections. --}}
<h1>Annual Wallet Report</h1>
<div class="meta">
...
@include('corpwalletmanager::reports.pdf._partials', ['kind' => 'annual'])
