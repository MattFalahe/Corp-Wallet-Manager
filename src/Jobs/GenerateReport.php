...
class GenerateReport implements ShouldQueue
{
    ...
    {
        // Ensure dates are Carbon instances (may be strings after queue serialization)
        $this->dateFrom = $this->dateFrom instanceof Carbon ? $this->dateFrom : Carbon::parse($this->dateFrom);
        $this->dateTo = $this->dateTo instanceof Carbon ? $this->dateTo : Carbon::parse($this->dateTo);
